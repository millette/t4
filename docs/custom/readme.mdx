...
npm install # les deps nodejs de notre serveur
cp passwords.json.sample passwords.json # éditer à votre guise
...
Maintenant que la base fonctionne, j'ai intégré le _theming_
